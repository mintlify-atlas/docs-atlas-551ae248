...
<Tip>
You can use any of these RPC endpoints with [any of our APIs](/tools/near-api) or wallet libraries.
</Tip>
...
|----------|---------------|-----------------|---------------|------------|
| [1RPC](https://docs.1rpc.io/) | `https://1rpc.io/near` | ✓ | | ✓ (20k req/day) |
| [All That Node](https://www.allthatnode.com/) | `https://allthatnode.com/protocol/near.dsrv` | | ✓ | ✓ (500,000 CU/day, 150 cups) |
| [ankr.com](https://www.ankr.com/docs/rpc-service/chains/chains-list/#near) | `https://rpc.ankr.com/near` | | | |
| [BlockPI Network](https://blockpi.io) | `https://near.blockpi.network/v1/rpc/public` | ✓ | | ✓ (50M RUs/month, 20 req/sec) |
| [dRPC](https://drpc.org/) | `https://near.drpc.org` | ✓ | | ✓ (210M CU/month, 100 req/sec) |
...
| [GetBlock](https://getblock.io/nodes/near/) | `https://getblock.io/nodes/near/` | ✓ | | ✓ (50K CU/day, 20 RPS, 2 access tokens) |
| [Grove](https://grove.city) | `https://near.rpc.grove.city/v1/01fdb492` | ✓ | ✓ | ✓ |
| [Lava Network](https://www.lavanet.xyz/get-started/near) | `https://near.lava.build:443` | ✓ | ✓ | ✓ |
| [Intear RPC](https://rainy.intea.rs) | `https://rpc.intea.rs` | ✓ | | ✓ |
| [Lavender.Five Nodes](https://lavenderfive.com/) | `https://near.lavenderfive.com/` | | | |
| [NodeReal](https://nodereal.io) | `https://nodereal.io/api-marketplace/near-rpc` | | | ✓ (100,000 CUs/month, 300 CUPS) |
| [NOWNodes](https://nownodes.io/) | `https://near.nownodes.io/` | | | ✓ (100,000 req/month, 1 API key, 15 RPS limit) |
| [OMNIA](https://omniatech.io) | `https://endpoints.omniatech.io/v1/near/mainnet/public` | ✓ | | |
| [QuickNode](https://www.quicknode.com/chains/near) | - | | | ✓ (15 RPS, 10M API credits/month) |
...
| [Tatum](https://tatum.io/chain/near/) | `https://near-mainnet.gateway.tatum.io/` | | | ✓ (3 Req/sec) |
...
| [dRPC](https://drpc.org/) | `https://near-testnet.drpc.org` | ✓ |
| [fast-near web4](https://github.com/vgrichina/fast-near) | `https://rpc.web4.testnet.page/account/testnet` | ✓ |
| [FASTNEAR](https://fastnear.com) | `https://rpc.testnet.fastnear.com` | ✓ |
| [Intear RPC](https://rainy.intea.rs) | `https://testnet-rpc.intea.rs` | ✓ |
| [Lava Network](https://www.lavanet.xyz/get-started/near) | `https://neart.lava.build:443` | ✓ |
